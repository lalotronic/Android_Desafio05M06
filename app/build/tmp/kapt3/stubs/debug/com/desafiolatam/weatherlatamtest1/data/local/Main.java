...
public final class Main {
    ...
    private final long seaLevel = 0L;
    private final long grndLevel = 0L;
    
    @org.jetbrains.annotations.NotNull
    public final com.desafiolatam.weatherlatamtest1.data.local.Main copy(double temp, double feels_like, double temp_min, double temp_max, long pressure, long humidity, long seaLevel, long grndLevel) {
        return null;
    }
    ...
    public Main(double temp, double feels_like, double temp_min, double temp_max, long pressure, long humidity, long seaLevel, long grndLevel) {
        super();
    }

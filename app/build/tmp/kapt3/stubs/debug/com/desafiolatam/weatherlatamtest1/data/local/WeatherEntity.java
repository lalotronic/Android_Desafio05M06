...
public final class WeatherEntity {
    ...
    @org.jetbrains.annotations.NotNull
    public final com.desafiolatam.weatherlatamtest1.data.local.WeatherEntity copy(int id, double currentTemp, double maxTemp, double minTemp, double pressure, double humidity, double windSpeed, long sunrise, long sunset, @org.jetbrains.annotations.NotNull
    ...
    public WeatherEntity(int id, double currentTemp, double maxTemp, double minTemp, double pressure, double humidity, double windSpeed, long sunrise, long sunset, @org.jetbrains.annotations.NotNull
    java.lang.String cityName) {
        super();
    }
